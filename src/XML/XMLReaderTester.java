 ...
 */
public class XMLReaderTester extends Application {
	...
	public void start(Stage primaryStage) throws Exception {
		...
		if (dataFile != null) {
			try {
				XMLReader x = new XMLReader(dataFile);
				System.out.println(x.getCellShape());
				System.out.println(x.getCellSize());
					System.out.println(x.getNeighborHandling());
